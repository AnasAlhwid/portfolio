...
Files: computer-optimized.glb [486.38KB] > .\portfolio\public\models\computer-optimized-transformed.glb [39.72KB] (92%)
*/

import { useGLTF } from '@react-three/drei'

export function Computer(props) {
  const { nodes, materials } = useGLTF('/models/contact/computer-optimized-transformed.glb')
  return (
...
useGLTF.preload('/models/contact/computer-optimized-transformed.glb')
